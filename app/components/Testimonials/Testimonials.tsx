...
export const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      feedback:
        "The Business Broadway's team was instrumental in helping us modernize our legacy systems. Their proactive approach and dedication to delivering results were remarkable.",
      image: "https://via.placeholder.com/100",
      linkedIn: "#",
    },
    {
      ...
      feedback:
        "Thanks to The Business Broadway, we scaled our application to handle millions of users seamlessly. Their expertise in scalable architecture is unmatched.",
      image: "https://via.placeholder.com/100",
      linkedIn: "#",
    },
  ];
    ...
    <LightGraySectionLayout>
      ...
      {/* <div className="bg-gray-50 py-16 px-6 md:px-12 lg:px-20"> */}
        <h2 className="text-3xl md:text-4xl font-bold text-center">
          What Clients Say{" "}
          <span className="text-red-600">About The Business Broadway</span>
        </h2>
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow-lg p-8 flex flex-col relative">
            ...
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M19 0h-14c-2.762 0-5 2.238-5 5v14c0 2.762 2.238 5 5 5h14c2.762 0 5-2.238 5-5v-14c0-2.762-2.238-5-5-5zm-11 20h-3v-10h3v10zm-1.5-11.25c-.966 0-1.75-.784-1.75-1.75s.784-1.75 1.75-1.75 1.75.784 1.75 1.75-.784 1.75-1.75 1.75zm13.5 11.25h-3v-5.5c0-1.653-3-1.528-3 0v5.5h-3v-10h3v1.5c1.396-2.586 6-2.777 6 2.476v6.024z" />
              </svg>
            </a>
